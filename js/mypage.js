...
document.getElementById('room-img').src = `room_img/${ACCOMODATION_ROOM[room]}.jpg`;  // 画像のパスを設定
...
document.getElementById('grouproom-img').src = `room_img/${ACTIVITY_GROUP_ROOM[activityGroupRoom]}.jpg`;  // 画像のパスを設定
...
document.getElementById('mixAroom-img').src = `room_img/${MIXA_ROOM[mixAroom]}.jpg`;  // 画像のパスを設定
...
document.getElementById('mixBroom-img').src = `room_img/${MIXB_ROOM[mixBroom]}.jpg`;  // 画像のパスを設定
