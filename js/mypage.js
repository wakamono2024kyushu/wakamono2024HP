...
document.getElementById('grouproom-img').scr = `room_img/${ACTIVITY_GROUP_ROOM[activityGroupRoom]}.png`;  // 画像のパスを設定
...
document.getElementById('mixAroom-img').scr = `room_img/${MIXA_ROOM[mixAroom]}.png`;  // 画像のパスを設定
...
document.getElementById('mixBroom-img').scr = `room_img/${MIXB_ROOM[mixBroom]}.png`;  // 画像のパスを設定
