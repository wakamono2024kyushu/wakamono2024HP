...
document.getElementById('room-img').src = `img/${ACCOMODATION_ROOM[room]}.png`;  // 画像のパスを設定
...
document.getElementById('grouproom-img').src = `room_img/${ACTIVITY_GROUP_ROOM[activityGroupRoom]}.png`;  // 画像のパスを設定
...
document.getElementById('mixAroom-img').src = `room_img/${MIXA_ROOM[mixAroom]}.png`;  // 画像のパスを設定
...
document.getElementById('mixBroom-img').src = `room_img/${MIXB_ROOM[mixBroom]}.png`;  // 画像のパスを設定
